...
question:The greatest common divisor (GCD) of a and b is the largest
 ...
 then gcd(a, b) = gcd(b, r). As a base case, 
 we can use gcd(a, 0) = a. Write a function called gcd that 
...
print "program for finding GCD of two numbers:"
